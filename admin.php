...
<html lang="en">
  <head>
    ...
    <title>Academic Daily Log | Admin</title>
  ...
  <body>
    ...
    <div class="container">
        <a class="navbar-brand" target="_blank" href=".">Academic Daily Log</a>
        <button
...
<li class="nav-item">
    ...
    <section id="content" class="p-5">
        <div class="container"> 
            ...
            echo '<h4 class="lead display-6 pb-2 border-bottom border-info-subtle">' . $page . '</h4>';
            include($page . ".php");
            ?>
        </div> 
    </section>
    ...
    <footer class="text-center p-3 bg-info-subtle">
			...
			<div>Najwa Handaria Suparna &copy; 2025</div>
    </footer>
    <!-- footer end -->
